...
CREATE TABLE `mempleado` (
  ...
  `appat_emp` varchar(45) DEFAULT NULL,
  `apmat_emp` varchar(45) DEFAULT NULL,
  `edad_emp` int(11) DEFAULT NULL,
  `email_emp` varchar(45) DEFAULT NULL,
  `puesto_emp` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2020-08-01  8:25:54
